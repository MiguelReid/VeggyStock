...
class NewItem : AppCompatActivity() {
    ...
    private var cameraCode: Int = 123
    ...
    private fun saveItem() {
        ...
        val name = binding.etName.context.getText(0)
        Log.d(TAG, name.toString())

        val provider = binding.etProvider.text.toString()
        val aux = binding.etPrice.text.toString()
        val price = aux.toFloat()
        val rating = binding.ratingBar.rating
        val address = binding.etStreet.text.toString()
